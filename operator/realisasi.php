            ...
            <div class="box-content"><br><br><br>
                ...
                <table class="table table-striped table-bordered table-hover table-responsive" id="datatable">
                    ...
                    <tbody>
                        ...
                        $sql = mysqli_query($konek, "SELECT * FROM d_simponi as S LEFT JOIN r_satker as D on D.kdsatker = S.kdsatker LEFT JOIN r_unit as U on U.kdunit = D.kdunit WHERE D.kdaktif = 1 AND S.kdunit = '$kdunit'");
                        $no=0;
