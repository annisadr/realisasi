...
<body>
    <div class="container">
        ...
        <div class="col-sm-3" align="right">
            <a href="index.php?page=trealisasi&&id_user=<?php echo $data['id_user']; ?>&&kdunit=<?php echo $data['kdunit']; ?>" class="btn btn-primary btn-lg">
    ...
    <div id="content" class="col-lg-12 col-sm-12">
        ...
        if(isset($_POST['cari'])){
            ...
            ?>
            <script>
                window.location='index.php?page=realisasi&&id_user=<?php echo $id_user; ?>&&kdunit=<?php echo $kdunit; ?>&&kdsatker=<?php echo $kdsatker; ?>&&jenis=<?php echo $jenis; ?>&&tanggalawal=<?php echo $tanggalawal; ?>&&tanggalakhir=<?php echo $tanggalakhir; ?>';
            </script>
            ...
            <div class="box-content"><br><br><br>
                ...
                <table>
                    ...
                    <tr>
                        <div class="col-sm-1" align="right">
                            <a href="print_realisasi.php?kdunit=<?php echo $getkdunit; ?>&&kdsatker=<?php echo $kdsatker; ?>&&jenis=<?php echo $jenis; ?>&&tanggalawal=<?php echo $tanggalawal; ?>&&tanggalakhir=<?php echo $tanggalakhir; ?>" class="btn btn-info btn-md" target ="_blank">
                ...
                <table class="table table-striped table-bordered table-hover table-responsive" id="datatable">
                    ...
                    <tbody>
                        ...
                        $sql = mysqli_query($konek, "SELECT * FROM d_simponi as S LEFT JOIN r_satker as D on D.kdsatker = S.kdsatker LEFT JOIN r_unit as U on U.kdunit = D.kdunit WHERE D.kdaktif = 1 AND D.kdunit = '$kdunit' AND D.kdsatker = '$getkdsatker' AND S.kode_uf = '$getjenis' AND S.tanggal BETWEEN '$gettanggalawal' AND '$gettanggalakhir'");
                        $no=0;
                        ...
                        while ($tampil = mysqli_fetch_array($sql)) {
                            ...
                            <a href="index.php?page=erealisasi&&id_user='.$data['id_user'].'&&kdunit='.$tampil['kdunit'].'&&wbws='.$tampil['wbws'].'&&NTPN='.$tampil['NTPN'].'"><span class="glyphicon glyphicon-edit"></span></a>
