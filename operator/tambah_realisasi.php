...
<div class="row">
  ...
  <form action="../config/proses_addrealisasi.php" method="POST" class="form-horizontal">
    ...
    <div class="form-group">
      ...
      <label class="control-label col-sm-1">:</label>
      <div class="col-sm-5">
        <input type="text" class="form-control" id="kode_billing" name="kode_billing" placeholder="Kode Billing">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <label class="control-label col-sm-1">:</label>
      <div class="col-sm-5">
        <input type="text" class="form-control" id="kode_bp" name="kode_bp" placeholder="Kode BP">
      </div>
    </div>

    <div class="form-group">
      <label class="control-label col-sm-2" for="NTPN">NTPN</label>
      <label class="control-label col-sm-1">:</label>
      <div class="col-sm-5">
    ...
    <div class="form-group">
      <label class="control-label col-sm-2" for="ntbntp">NTB / NTP</label>
      <label class="control-label col-sm-1">:</label>
      <div class="col-sm-5">
        <input type="text" class="form-control" id="ntbntp" name="ntbntp" placeholder="NTB / NTP">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <label class="control-label col-sm-1">:</label>
      <div class="col-sm-5">
        <input type="text" class="form-control" id="kode_uf" name="kode_uf" placeholder="Kode U/F" >
      </div>
    </div>

    <div class="form-group">
      <label class="control-label col-sm-2" for="kode_mu">Kode MU</label>
      <label class="control-label col-sm-1">:</label>
      <div class="col-sm-5">
        <input type="text" class="form-control" id="kode_mu" name="kode_mu" placeholder="Kode MU">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <label class="control-label col-sm-1">:</label>
      <div class="col-sm-5">
        <input type="text" class="form-control" id="jml_setoran" name="jml_setoran" placeholder="Jumlah Setoran">
      </div>
    </div>
