            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <select class="form-control" id="unit" name="unit">
                        <option selected="selected">15 | BADAN PENGEMBANGAN SUMBER DAYA MANUSIA</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <select class="form-control" id="nmsatker" name="kdsatker">
                        <option selected="selected">--Pilih Satuan Kerja--</option>
                            ...
                            LEFT JOIN r_satker AS S ON S.kdunit = U.kdunit WHERE S.kdunit = '15' AND S.kdaktif = 1 ORDER BY nmsatker";
