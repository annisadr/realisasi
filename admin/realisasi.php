                ...
                <table>
                    ...
                    <tr>
                        <div class="col-sm-1" align="right">
                            <a href="print_realisasi.php?kdunit=<?php echo $getkdunit ?>&kdsatker=<?php echo $getkdsatker ?>&jenis=<?php echo $getjenis ?>&tanggalawal=<?php echo $gettanggalawal ?>&tanggalakhir=<?php echo $gettanggalakhir ?>" class="btn btn-info btn-md" target ="_blank">
